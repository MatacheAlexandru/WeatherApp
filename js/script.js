...
function getWeather(city) {
  ...
  const apiUrl = `https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${city}&days=3`; // Modificat la HTTPS
  $.ajax({
    url: apiUrl,
    method: "GET",
...
function getWeatherByCoordinates(lat, lon) {
  const apiKey = "b429d88ed86c4d4996a202219241307";
  const apiUrl = `https://api.weatherapi.com/v1/forecast.json?key=${apiKey}&q=${lat},${lon}&days=3`; // Modificat la HTTPS
  $.ajax({
    url: apiUrl,
    method: "GET",
    success: function (data) {
